/*
  # Create celestial bodies table with enhanced schema
  ...
  1. New Tables
    - `celestial_bodies`
      ...
      - `position_x`, `position_y`, `position_z` (double precision, required)
  ...
  3. Enums
    - Create `content_type_enum` for content classification
*/
...
DO $$ BEGIN
    DROP POLICY IF EXISTS "Users can view their own celestial bodies" ON celestial_bodies;
    DROP POLICY IF EXISTS "Users can insert their own celestial bodies" ON celestial_bodies;
    DROP POLICY IF EXISTS "Users can update their own celestial bodies" ON celestial_bodies;
    DROP POLICY IF EXISTS "Users can delete their own celestial bodies" ON celestial_bodies;
END $$;
